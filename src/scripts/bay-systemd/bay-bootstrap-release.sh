...
COCALC_BAY_PGBACKREST_CONFIG=${BAY_ROOT}/backups/pgbackrest/pgbackrest.conf
COCALC_BAY_PGBACKREST_SPOOL_PATH=${BAY_ROOT}/backups/pgbackrest/spool
...
COCALC_BAY_SQLITE_MIRROR_DIR=${BAY_ROOT}/backups/sqlite-mirror/sync
COCALC_BAY_SQLITE_MIRROR_CATALOG=${BAY_ROOT}/backups/sqlite-mirror/catalog.json
...
COCALC_BAY_SQLITE_RUSTIC_BIN=/opt/cocalc/bin2/rustic
COCALC_BAY_SQLITE_RUSTIC_PROFILE=${BAY_ROOT}/backups/sqlite-mirror/rustic.toml
