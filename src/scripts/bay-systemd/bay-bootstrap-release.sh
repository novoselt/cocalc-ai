...
COCALC_LOCAL_PG_ARCHIVE=1
COCALC_LOCAL_PG_ARCHIVE_TIMEOUT=1h
...
EOF
  ...
  set_env_var "${ENV_DIR}/bay.env" "COCALC_LOCAL_PG_ARCHIVE" "1"
  set_env_var "${ENV_DIR}/bay.env" "COCALC_LOCAL_PG_ARCHIVE_TIMEOUT" "1h"
