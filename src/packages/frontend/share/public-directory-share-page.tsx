...
function resolvedShareFromGrant({
  ...
  return {
    ...
    reader_instructions: grant.reader_instructions ?? null,
    publisher_reader_instructions: grant.publisher_reader_instructions ?? null,
    publisher_account_id: grant.publisher_account_id ?? null,
