...
export const compute = {
  ...
  listProjectVms: authFirstRequireProject,
  getProjectVm: authFirstRequireProject,
  ...
  listProjectVolumes: authFirstRequireProject,
  getProjectVolume: authFirstRequireProject,
